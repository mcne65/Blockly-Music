...
# This demonstrates that decodebin will clip its output to start exactly at the seek time.
# pravegasrc reads 34 seconds of clipped data, ensuring that all headers are received.
